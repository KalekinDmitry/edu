            ...
            <div class="row justify-content-center">
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-6 card"
                    ...
                    <div class="text-white card-header"
                        ...
                        <h2 style="margin-top: 10px;"><strong style="padding-left: 20px;">@lang('content.crclassrm')</strong></h2>
                    </div>
                    <div class="card-body">


                        <form class="contact-form" action="{{ route('classroom.store') }}" method="POST" style="padding-left: 20px; padding-right: 20px"
