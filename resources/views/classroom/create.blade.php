                        ...
                        <form class="contact-form" action="{{ route('classroom.store') }}" method="POST"
                            ...
                            <div class="row justify-content-left">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="col-md-9" style="background-color:lightgray" type="text"
                                ...
                                <div class="col-md-10">
                                    ...
                                    <button type="button" class="site-btn-info col-md-4" data-toggle="modal"
                                    ...
                                    <button type="button" class="site-btn-danger col-md-4" data-toggle="modal"
