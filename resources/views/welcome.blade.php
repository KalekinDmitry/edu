    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 about-text">
                ...
                <!-- p>We are glad to welcome you on the pages of our course. We are certified teachers who know their subject.</p -->
                <!-- p>The course is dedicated to personal growth, personal development strategy in business, and the method of self-improvement in a rapidly developing market.</p -->
...
<!-- Newslatter section -->
<section class="newslatter-section set-bg" data-setbg="{{ asset('images/newslatter-bg.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
